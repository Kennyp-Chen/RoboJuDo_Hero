...
class G1UnitreeMjlabDoF(DoFConfig):
    ...
    default_pos: list[float] | None = [-0.1,0,0,0.3,-0.2,0, -0.1,0,0,0.3,-0.2,0,  0,0,0, 
...
class G1UnitreeMjlab23DoF(DoFConfig):
    ...
    default_pos: list[float] | None = [
        -0.1,    0,  0,  0.3,    -0.2,   0,  -0.1,   0,  0,  0.3,    -0.2,   0, # 0,
        0, 0,  0.35,0.18,0,0.87,#0,
        0, 0, 0.35,-0.18,0,0.87,#0,
        0, 0
      ]
    stiffness: list[float] | None = [
        40.2, 99.1, 40.2, 99.1, 28.5, 28.5, 40.2, 99.1, 40.2, 99.1, 28.5, 28.5,# 40.2,
        28.5, 28.5,14.3, 14.3, 14.3, 14.3, #14.3,
        16.8, 16.8, 14.3, 14.3, 14.3, 14.3, #14.3, 
        16.8, 16.8]

    damping: list[float] | None = [
        2.6, 6.3, 2.6, 6.3, 1.8, 1.8, 2.6, 6.3, 2.6, 6.3, 1.8, 1.8, #2.6, 
        1.8, 1.8,0.9, 0.9, 0.9, 0.9, #0.9, 
        1.1, 1.1,0.9, 0.9, 0.9, 0.9, #0.9,
        1.1, 1.1]
...
class G123dofUnitreeMjlabVelocityPolicyCfg(UnitreeMjlabVelocityPolicyCfg):
    """
    参考 UnitreeWoGaitPolicyCfg
    将UnitreeWoGaitPolicyCfg+G1UnitreeWoGaitPolicyCfg合并
    /home/hero/Projects/Robotics/Sim2Real/RoboJuDo/robojudo/policy/policy_cfgs.py
