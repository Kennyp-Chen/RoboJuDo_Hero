...
from robojudo.pipeline.pipeline_cfgs import RlLocoMimicSimPipelineCfg
...
class RlLocoMimicSimPipeline(RlMultiPolicyPipeline):
    cfg: RlLocoMimicSimPipelineCfg

    @property
    def policy(self) -> PolicyWrapper:
        return self.policy_manager.policy

    def __init__(self, cfg: RlLocoMimicSimPipelineCfg):
