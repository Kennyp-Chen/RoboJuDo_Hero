...
policy_registry.add("G1UnitreeMjlabVelocityPolicy", ".unitree_mjlab_velocity_policy")
policy_registry.add("G1AmpPolicy", ".amp_policy")
policy_registry.add("G1AmpRunWalkPolicy", ".amp_policy")
policy_registry.add("G1AmpRecoveryPolicy", ".amp_policy")
...
policy_registry.add("MultiModalWBCPolicy", ".multimodalwbc_policy")
