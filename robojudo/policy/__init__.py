...
policy_registry.add("G1AmpPolicy", ".g1_amp_policy")
policy_registry.add("G1AmpRunWalkPolicy", ".g1_amp_policy")
policy_registry.add("G1AmpRecoveryPolicy", ".g1_amp_policy")
